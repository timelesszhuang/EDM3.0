<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/home/wwwroot/edm5.0/public/../application/index/view/template/add.html";i:1490150955;}*/ ?>
<!----该文件是打开窗体之后的页面-->
<?php
...
<div class="modal-body">
    <form class="form-horizontal" id="<?php echo $page_id; ?>_toaction" onsubmit="return false">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" id="<?php echo $page_id; ?>_type" value="">
