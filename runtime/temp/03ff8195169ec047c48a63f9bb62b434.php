<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/home/wwwroot/edm5.0/public/../application/index/view/sendconfig/index.html";i:1489808102;}*/ ?>
<?php
$page_id="template";
?>
    ...
    function load_user_datagrid(datagrid_id, urljson, hrefedit, hrefcancel, edit_modal) {
        $('#' + datagrid_id).datagrid({
            ...
            columns: [[
                ...
                {field: 'template_name', title: '模板名称', width: 5},
                {field: 'id', title: '发送id', align: 'center'},
