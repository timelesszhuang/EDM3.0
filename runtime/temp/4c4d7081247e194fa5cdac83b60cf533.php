<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/home/wwwroot/edm5.0/public/../application/index/view/link/save.html";i:1489718307;}*/ ?>
<!----该文件是打开窗体之后的页面-->
<?php
$page_id="link_save";
?>
...
<div class="modal-body">
    <form class="form-horizontal" id="<?php echo $page_id; ?>_toaction" onsubmit="return false">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="link_title" value="<?php echo $data['link_title']; ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="" class="control-label col-sm-3">链接：</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" name="redirect_url" value="<?php echo $data['redirect_url']; ?>">
            </div>
        </div>
...
<script>
    $("#<?php echo $page_id; ?>_add_producttype_btn").click(function () {
        var obj = {
            add_email_template_url: "<?php echo URL('index/Link/saveData'); ?>"
        };
